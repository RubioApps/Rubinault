...
class Language
{
     ...
     *
     */
    public function getKnownLanguages($basePath = RBNO_SITE)
    {
    ...
    public function getLanguages($key = 'default')
    {
        ...
        if (empty($this->languages)) {
            $languages[$key] = array();
            $knownLangs = $this->getKnownLanguages(RBNO_SITE);
     ...
     */
    public function getLanguagePath($basePath = RBNO_SITE, $language = null)
    {
    ...
    public function getMetadata($lang)
    {
        ...
        $file = $this->getLanguagePath(RBNO_SITE, $lang) . '/langmetadata.xml';

        if (!is_file($file)) {
            $file = $this->getLanguagePath(RBNO_SITE, $lang) . '/' . $lang . '.xml';
        }
     ...
     *
     */
    public function load($basePath = RBNO_SITE, $lang = null, $reload = false, $default = true)
    {
